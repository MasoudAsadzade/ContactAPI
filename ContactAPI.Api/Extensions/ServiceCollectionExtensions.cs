...
using ContactAPI.Infrastructure.Identity.Services;
using ContactAPI.Infrastructure.Shared.Services;
...
namespace ContactAPI.Api.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            ...
            {
                c.IncludeXmlComments(string.Format(@"{0}\ContactAPI.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
