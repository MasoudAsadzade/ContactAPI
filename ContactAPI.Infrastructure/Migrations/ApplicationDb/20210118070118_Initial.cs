    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contacts", x => x.UserIdentityId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactSkills", x => new { x.UserIdentityId, x.SkillId });
                    table.ForeignKey(
                        name: "FK_ContactSkills_Contacts_UserIdentityId",
